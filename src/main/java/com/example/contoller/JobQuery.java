...
public class JobQuery {
	...
	@Scheduled(cron = "08 24 *	*  * * * ", zone = "Asia/Colombo")
	public void createExcel() throws IOException {
		...
		XSSFSheet sheet = workbook.createSheet("expencetest");
		...
		if (queryStatus == 2) {
			for (QueryModel query : queryReportForExcel) {
				...
				if (closedDate != date3) {
					System.out.println(closedDate + "closedDateclosedDate");
					closedDateExcel = dateFormat.format(closedDate);
					System.out.println(closedDateExcel + "closedDateExcelclosedDateExcel");
					int rownum = 0;
	...
	@Scheduled(cron = "12 16 *	*  * * * ", zone = "Asia/Colombo")
	public void test() throws IOException {

		int status = 0;
		int queryStatus=0;
		String[] columns = { "Client", "Raised On", "Queries/Enhancements","Raised By" , "Raised through" , "Attended By", "Comments", "Closed By", "Closed On"};
